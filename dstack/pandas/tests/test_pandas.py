...
class TestPandas(TestBase):
    def test_with_schema(self):
        df = pd.DataFrame({"float": [1.0],
                           ...
                           "string": ["foo"]})
        push_frame("test/pandas/df_with_schema", df, encoder=DataFrameEncoder(index=False))
    ...
    def test_df_with_index(self):
        ...
        push_frame("test/pandas/df_with_index", df)
    ...
    def test_df_with_non_int_index(self):
        ...
        push_frame("test/pandas/df_with_index_non_int", df)
    ...
    def test_series(self):
        ...
        s = pd.Series(data)
        push_frame("test/pandas/series", s, encoder=SeriesEncoder(index=False))
    ...
    def test_series_with_index(self):
        ...
        push_frame("test/pandas/series_with_index", s)
