...
class TestControls(TestCase):
    ...
    def test_simple_update(self):
        ...
        c2 = ctrl.TextField(id="c2", parents=c1, update_func=update)
    ...
    def test_update_func_called_only_once(self):
        ...
        c1 = ctrl.TextField("10", id="c1")
        c2 = ctrl.TextField(id="c2", parents=c1, update_func=update_c2)
        c3 = ctrl.TextField(id="c3", parents=c2, update_func=update_c3_c4)
        c4 = ctrl.TextField(id="c4", parents=c2, update_func=update_c3_c4)
    ...
    def test_combo_box(self):
        ...
        c1 = ctrl.ComboBox(update_func=update, parents=cb, id="c1")
    ...
    def test_combo_box_callable_model(self):
        ...
        cities = ctrl.ComboBox(update_func=update_cities, id="cities", parents=countries)
